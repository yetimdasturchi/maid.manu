...
final class TableOfContentsGenerator implements TableOfContentsGeneratorInterface
{
    ...
    public function generate(Document $document): ?TableOfContents
    {
        ...
        foreach ($this->getHeadingLinks($document) as $headingLink) {
            ...
            // Create the new link
            $link = new Link(current_url().'#' . $this->fragmentPrefix . $headingLink->getSlug(), StringContainerHelper::getChildText($heading, [RawMarkupContainerInterface::class]));
            $link->setTitle($headingLink->getText());
